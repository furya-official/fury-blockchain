...
// source: fury/legacy/did/did.proto
...
func (m *FuryDid) Reset()         { *m = FuryDid{} }
func (m *FuryDid) String() string { return proto.CompactTextString(m) }
...
func (m *FuryDid) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FuryDid.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FuryDid) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FuryDid.Merge(m, src)
}
func (m *FuryDid) XXX_Size() int {
	return m.Size()
}
func (m *FuryDid) XXX_DiscardUnknown() {
	xxx_messageInfo_FuryDid.DiscardUnknown(m)
}

var xxx_messageInfo_FuryDid proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*FuryDid)(nil), "legacydid.FuryDid")
	proto.RegisterType((*Secret)(nil), "legacydid.Secret")
}

func init() { proto.RegisterFile("fury/legacy/did/did.proto", fileDescriptor_515f25a9bd100c9a) }
...
func (m *FuryDid) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FuryDid: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FuryDid: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
