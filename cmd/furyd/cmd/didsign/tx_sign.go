...
func sign(txf tx.Factory, clientCtx client.Context, txBuilder client.TxBuilder, overwriteSig bool, furyDid didtypes.FuryDid) error {
...
func makeSignCmd() func(cmd *cobra.Command, args []string) error {
	return func(cmd *cobra.Command, args []string) (err error) {
		...
		singerDid, err := didtypes.UnmarshalFuryDid(args[0])
		if err != nil {
			return err
		}
