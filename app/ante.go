...
import (
	...
	iidante "github.com/furya-official/fury-blockchain/x/iid/ante"
	iidkeeper "github.com/furya-official/fury-blockchain/x/iid/keeper"
	projectante "github.com/furya-official/fury-blockchain/x/project/ante"
	...
	handler := func(ctx sdk.Context, tx sdk.Tx, simulate bool) (newCtx sdk.Context, err error) {
		...
		if checkForCreateProjectMessages(tx) {
			...
			anteDecorators = []sdk.AnteDecorator{
				...
				// furyante.NewCheckTxForIncompatibleMsgsDecorator(), // outermost AnteDecorator. SetUpContext must be called first
			...
			anteDecorators = []sdk.AnteDecorator{
				...
				// furyante.NewCheckTxForIncompatibleMsgsDecorator(),
