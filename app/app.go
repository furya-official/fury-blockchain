...
import (
	...
	"github.com/furya-official/fury-blockchain/client/tx"
	libfury "github.com/furya-official/fury-blockchain/lib/fury"
	"github.com/furya-official/fury-blockchain/x/bonds"
	bondskeeper "github.com/furya-official/fury-blockchain/x/bonds/keeper"
	bondstypes "github.com/furya-official/fury-blockchain/x/bonds/types"

	// this line is used by starport scaffolding # stargate/app/moduleImport
	entitymodule "github.com/furya-official/fury-blockchain/x/entity"
	entityclient "github.com/furya-official/fury-blockchain/x/entity/client"
	entitykeeper "github.com/furya-official/fury-blockchain/x/entity/keeper"
	entitytypes "github.com/furya-official/fury-blockchain/x/entity/types"

	tokenmodule "github.com/furya-official/fury-blockchain/x/token"
	tokenclient "github.com/furya-official/fury-blockchain/x/token/client"
	tokenkeeper "github.com/furya-official/fury-blockchain/x/token/keeper"
	tokentypes "github.com/furya-official/fury-blockchain/x/token/types"

	iidmodule "github.com/furya-official/fury-blockchain/x/iid"
	iidmodulekeeper "github.com/furya-official/fury-blockchain/x/iid/keeper"
	iidtypes "github.com/furya-official/fury-blockchain/x/iid/types"
	"github.com/furya-official/fury-blockchain/x/payments"
	paymentskeeper "github.com/furya-official/fury-blockchain/x/payments/keeper"
	paymentstypes "github.com/furya-official/fury-blockchain/x/payments/types"
	"github.com/furya-official/fury-blockchain/x/project"
	projectkeeper "github.com/furya-official/fury-blockchain/x/project/keeper"
	projecttypes "github.com/furya-official/fury-blockchain/x/project/types"
...
var (
	...
	DefaultNodeHome = os.ExpandEnv("$HOME/.furyd")
...
func NewFuryApp(
	...
	furyAnteHandler, err := FuryAnteHandler(HandlerOptions{
		...
		SigGasConsumer:  libfury.FurySigVerificationGasConsumer,
	})
	if err != nil {
		panic(err)
	}
...
// func NewFuryAnteHandler(app *FuryApp, encodingConfig params.EncodingConfig, wasmConfig WasmTypes.WasmConfig, key sdk.StoreKey) sdk.AnteHandler {
...
// 	//
// 	// In the case of fury, since signers are DIDs rather than addresses, we get
...
// 	// - [[default]] remaining fury module msgs are signed by did module DIDs
// 	//
...
// 	// fury AnteHandler (fury.NewDefaultAnteHandler) for all three pubkey getters
// 	// instead of having to implement three unique AnteHandlers.

// 	defaultFuryAnteHandler := furytypes.NewDefaultAnteHandler(
// 		app.AccountKeeper, app.BankKeeper, furytypes.FurySigVerificationGasConsumer,
// 		defaultPubKeyGetter, encodingConfig.TxConfig.SignModeHandler(), key, app.IBCKeeper,
// 		wasmConfig)
// 	iidAnteHandler := furytypes.NewDefaultAnteHandler(
// 		app.AccountKeeper, app.BankKeeper, furytypes.FurySigVerificationGasConsumer,
// 		iidPubKeyGetter, encodingConfig.TxConfig.SignModeHandler(), key, app.IBCKeeper,
// 		wasmConfig)
// 	projectAnteHandler := furytypes.NewDefaultAnteHandler(
// 		app.AccountKeeper, app.BankKeeper, furytypes.FurySigVerificationGasConsumer,
...
// 	// is that we use an FurySigVerificationGasConsumer instead of the default
...
// 		FeegrantKeeper:  app.FeeGrantKeeper,
// 		SignModeHandler: encodingConfig.TxConfig.SignModeHandler(),
// 		SigGasConsumer:  furytypes.FurySigVerificationGasConsumer,
// 	}
...
// 	// through fury-cellnode). The project however does have an original creator!
// 	//
...
// 		// Route message based on fury module router key
...
// 			return defaultFuryAnteHandler(ctx, tx, simulate)
// 		default:
