...
furyd_tx bonds buy 20000abc 100000res "$BOND_DID" "$MIGUEL_DID_FULL" 
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 20000abc..."
furyd_tx bonds buy 20000abc 100000res "$BOND_DID" "$FRANCESCO_DID_FULL" 
echo "Francesco's account..."
furyd_q bank balances "$FRANCESCO_ADDR"

echo "Shaun cannot buy 10001abc..."
furyd_tx bonds buy 10001abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun cannot sell anything..."
furyd_tx bonds sell 10000abc "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun can buy 10000abc..."
furyd_tx bonds buy 10000abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
...
furyd_tx bonds sell 20000abc "$BOND_DID" "$MIGUEL_DID_FULL" 
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"
