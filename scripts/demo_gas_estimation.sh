...
furyd_tx did add-did-doc "$MIGUEL_DID_FULL" --broadcast-mode block -y
echo "Ledgering DID 2/2..."
furyd_tx did add-did-doc "$FRANCESCO_DID_FULL" --broadcast-mode block -y
...
furyd_tx bonds buy 10abc 1000000res "$BOND_DID" "$MIGUEL_DID_FULL" --broadcast-mode block -y

echo "Francesco buys 10abc..."
furyd_tx bonds buy 10abc 1000000res "$BOND_DID" "$FRANCESCO_DID_FULL" --broadcast-mode block -y

echo "Miguel sells 10abc..."
furyd_tx bonds sell 10abc "$BOND_DID" "$MIGUEL_DID_FULL" --broadcast-mode block -y

echo "Francesco sells 10abc..."
furyd_tx bonds sell 10abc "$BOND_DID" "$FRANCESCO_DID_FULL" --broadcast-mode block -y
