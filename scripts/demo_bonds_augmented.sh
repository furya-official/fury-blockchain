...
furyd_tx bonds buy 100000abc 100000000000res "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 100000abc..."
furyd_tx bonds buy 100000abc 100000000000res "$BOND_DID" "$FRANCESCO_DID_FULL"
...
echo "Miguel buys 100000abc..."
furyd_tx bonds buy 100000abc 200000000000res "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"
...
furyd_tx bonds buy 1abc 2000000res "$BOND_DID" "$MIGUEL_DID_FULL"

echo "Francesco makes outcome payment of 60000000000..."
furyd_tx bonds make-outcome-payment "$BOND_DID" "60000000000" "$FRANCESCO_DID_FULL"
echo "Francesco's account..."
furyd_q bank balances "$FRANCESCO_ADDR"
