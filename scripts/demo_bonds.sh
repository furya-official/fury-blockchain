...
furyd_tx bonds buy 10abc 1000000res "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 10abc..."
furyd_tx bonds buy 10abc 1000000res "$BOND_DID" "$FRANCESCO_DID_FULL"
echo "Francesco's account..."
furyd_q bank balances "$FRANCESCO_ADDR"

echo "Miguel sells 10abc..."
furyd_tx bonds sell 10abc "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
furyd_q bank balances "$MIGUEL_ADDR"
