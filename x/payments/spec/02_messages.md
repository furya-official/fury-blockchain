...
|:----------------|:------------------|:----------------|
| CreatorDid      | `did.Did`         | DID of the template creator (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
...
| **Field**         | **Type**         | **Description** |
|:------------------|:-----------------|:----------------|
| CreatorDid        | `did.Did`        | DID of the contract creator (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
...
| Payer             | `sdk.AccAddress` | Address from where tokens will be deducted (e.g. `fury1cpa6w2wnqyxpxm4rryfjwjnx75kn4xt372dp3y`)
...
| **Field**         | **Type**   | **Description** |
|:------------------|:-----------|:----------------|
| CreatorDid        | `did.Did`  | DID of the subscription creator (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
...
| **Field**         | **Type**  | **Description** |
|:------------------|:----------|:----------------|
| PayerDid          | `did.Did` | DID of the payer associated with the contract (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
...
| **Field**         | **Type**         | **Description** |
|:------------------|:-----------------|:----------------|
| SenderDid         | `did.Did`        | DID of the discount granter (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
...
| Recipient         | `sdk.AccAddress` | The recipient of the discount (e.g. `fury1cpa6w2wnqyxpxm4rryfjwjnx75kn4xt372dp3y`)
...
| **Field**         | **Type**         | **Description** |
|:------------------|:-----------------|:----------------|
| SenderDid         | `did.Did`        | DID of the discount revoker (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
| PaymentContractId | `string`         | ID of the contract from which the discount is being revoked (e.g. `payment:contract:contract1`)
| Holder            | `sdk.AccAddress` | The current holder of the discount (e.g. `fury1cpa6w2wnqyxpxm4rryfjwjnx75kn4xt372dp3y`)
...
| **Field**         | **Type**         | **Description** |
|:------------------|:-----------------|:----------------|
| SenderDid         | `did.Did`        | DID of the message sender (e.g. `did:fury:4XJLBfGtWSGKSz4BeRxdun`)
