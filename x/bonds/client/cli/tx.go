...
import (
	...
	bondsclient "github.com/furya-official/fury-blockchain/x/bonds/client"
...
func NewCmdCreateBond() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			// Parse creator's fury DID
			creatorDid, err := didtypes.UnmarshalFuryDid(_creatorDid)
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), creatorDid, msg)
		},
	}
...
func NewCmdEditBond() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse editor's fury DID
			editorDid, err := didtypes.UnmarshalFuryDid(_editorDid)
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), editorDid, msg)
		},
	}
...
func NewCmdBuy() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse buyer's fury DID
			buyerDid, err := didtypes.UnmarshalFuryDid(args[3])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), buyerDid, msg)
		},
	}
...
func NewCmdSell() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse seller's fury DID
			sellerDid, err := didtypes.UnmarshalFuryDid(args[2])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), sellerDid, msg)
		},
	}
...
func NewCmdSwap() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse swapper's fury DID
			swapperDid, err := didtypes.UnmarshalFuryDid(args[4])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), swapperDid, msg)
		},
	}
...
func NewCmdMakeOutcomePayment() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse sender's fury DID
			sender, err := didtypes.UnmarshalFuryDid(args[2])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), sender, msg)
		},
	}
...
func NewCmdWithdrawShare() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse recipient's fury DID
			recipientDid, err := didtypes.UnmarshalFuryDid(args[1])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), recipientDid, msg)
		},
	}
...
func NewCmdWithdrawReserve() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse withdrawer's fury DID
			withdrawerDid, err := didtypes.UnmarshalFuryDid(args[2])
			if err != nil {
				return err
			}
			...
			return furytypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), withdrawerDid, msg)
		},
	}
