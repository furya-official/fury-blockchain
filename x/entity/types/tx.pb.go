...
type MsgCreateEntity struct {
	...
	OwnerDid             github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,17,opt,name=ownerDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
...
type MsgUpdateEntity struct {
	...
	ControllerDid        github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,8,opt,name=controllerDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"controller_did" yaml:"controller_did"`
...
type MsgTransferEntity struct {
	...
	OwnerDid     github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=ownerDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
	OwnerAddress string                                                          `protobuf:"bytes,3,opt,name=ownerAddress,proto3" json:"owner_address" yaml:"owner_address"`
	RecipientDid github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=recipientDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"recipient_did" yaml:"recipient_did"`
}
