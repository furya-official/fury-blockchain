...
func init() {
	...
	proto.RegisterType((*QueryEntityDocRequest)(nil), "fury.entity.v1beta1.QueryEntityDocRequest")
	proto.RegisterType((*QueryEntityDocResponse)(nil), "fury.entity.v1beta1.QueryEntityDocResponse")
	proto.RegisterType((*QueryEntityConfigRequest)(nil), "fury.entity.v1beta1.QueryEntityConfigRequest")
	proto.RegisterType((*QueryEntityConfigResponse)(nil), "fury.entity.v1beta1.QueryEntityConfigResponse")
	proto.RegisterMapType((map[string]string)(nil), "fury.entity.v1beta1.QueryEntityConfigResponse.MapEntry")
}
...
func (c *queryClient) EntityDoc(ctx context.Context, in *QueryEntityDocRequest, opts ...grpc.CallOption) (*QueryEntityDocResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.entity.v1beta1.Query/EntityDoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EntityConfig(ctx context.Context, in *QueryEntityConfigRequest, opts ...grpc.CallOption) (*QueryEntityConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.entity.v1beta1.Query/EntityConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EntityDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.entity.v1beta1.Query/EntityDoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_EntityConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.entity.v1beta1.Query/EntityConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
