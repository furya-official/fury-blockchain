...
const (
	...
	ContractType_FURY1155 ContractType = 2
)
...
type Params struct {
	...
	Fury1155ContractCode string `protobuf:"bytes,3,opt,name=fury1155ContractCode,proto3" json:"fury1155_contract_code" yaml:"fury1155_contract_code"`
}
...
type TokenMinter struct {
	...
	ContractType    ContractType                                                    `protobuf:"varint,4,opt,name=contractType,proto3,enum=fury.token.v1beta1.ContractType" json:"contract_type" yaml:"contract_type"`
...
func init() {
	proto.RegisterEnum("fury.token.v1beta1.ContractType", ContractType_name, ContractType_value)
	proto.RegisterType((*Contract)(nil), "fury.token.v1beta1.Contract")
	proto.RegisterType((*Params)(nil), "fury.token.v1beta1.Params")
	proto.RegisterType((*TokenMinter)(nil), "fury.token.v1beta1.TokenMinter")
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Fury1155ContractCode) > 0 {
		i -= len(m.Fury1155ContractCode)
		copy(dAtA[i:], m.Fury1155ContractCode)
		i = encodeVarintToken(dAtA, i, uint64(len(m.Fury1155ContractCode)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Fury1155ContractCode = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipToken(dAtA[iNdEx:])
