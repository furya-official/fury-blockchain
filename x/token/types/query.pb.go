...
func init() {
	...
	proto.RegisterType((*QueryTokenConfigRequest)(nil), "fury.token.v1beta1.QueryTokenConfigRequest")
	proto.RegisterType((*QueryTokenConfigResponse)(nil), "fury.token.v1beta1.QueryTokenConfigResponse")
	proto.RegisterMapType((map[string]string)(nil), "fury.token.v1beta1.QueryTokenConfigResponse.MapEntry")
}
...
func (c *queryClient) TokenConfig(ctx context.Context, in *QueryTokenConfigRequest, opts ...grpc.CallOption) (*QueryTokenConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Query/TokenConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TokenConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Query/TokenConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
