...
import (
	...
	_ "github.com/furya-official/fury-blockchain/x/iid/types"
...
type MsgSetupMinter struct {
	MinterDid     github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=minterDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
...
type MsgMint struct {
	...
	OwnerDid        github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=ownerDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
...
func init() {
	...
	proto.RegisterType((*Cw20Coin)(nil), "fury.token.v1beta1.Cw20Coin")
	proto.RegisterType((*SetupCw20)(nil), "fury.token.v1beta1.SetupCw20")
	proto.RegisterType((*SetupCw721)(nil), "fury.token.v1beta1.SetupCw721")
	proto.RegisterType((*SetupCw1155)(nil), "fury.token.v1beta1.SetupCw1155")
	proto.RegisterType((*MsgSetupMinter)(nil), "fury.token.v1beta1.MsgSetupMinter")
	proto.RegisterType((*MsgSetupMinterResponse)(nil), "fury.token.v1beta1.MsgSetupMinterResponse")
	proto.RegisterType((*MintCw20)(nil), "fury.token.v1beta1.MintCw20")
	proto.RegisterType((*MintCw721)(nil), "fury.token.v1beta1.MintCw721")
	proto.RegisterType((*MintCw1155)(nil), "fury.token.v1beta1.MintCw1155")
	proto.RegisterType((*MsgMint)(nil), "fury.token.v1beta1.MsgMint")
	proto.RegisterType((*MsgMintResponse)(nil), "fury.token.v1beta1.MsgMintResponse")
}
...
func (c *msgClient) SetupMinter(ctx context.Context, in *MsgSetupMinter, opts ...grpc.CallOption) (*MsgSetupMinterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/SetupMinter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetupMinter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/SetupMinter",
	}
...
func (m *MsgSetupMinter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.MinterDid = github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *MsgMint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.OwnerDid = github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Cw20", wireType)
