...
func (m *MintAuthorization) GetMinterDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.MinterDid
	}
	return ""
...
func init() {
	proto.RegisterType((*Cw20Constraints)(nil), "fury.token.v1beta1.Cw20Constraints")
	proto.RegisterType((*Cw721Constraints)(nil), "fury.token.v1beta1.Cw721Constraints")
	proto.RegisterType((*Cw1155Constraints)(nil), "fury.token.v1beta1.Cw1155Constraints")
