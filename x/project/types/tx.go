...
var (
	_ furytypes.FuryMsg = &MsgCreateProject{}
	_ furytypes.FuryMsg = &MsgUpdateProjectStatus{}
	_ furytypes.FuryMsg = &MsgCreateAgent{}
	_ furytypes.FuryMsg = &MsgUpdateAgent{}
	_ furytypes.FuryMsg = &MsgCreateClaim{}
	_ furytypes.FuryMsg = &MsgCreateEvaluation{}
	_ furytypes.FuryMsg = &MsgWithdrawFunds{}
	_ furytypes.FuryMsg = &MsgUpdateProjectDoc{}
)
...
func (msg MsgCreateProject) ToStdSignMsg(fee int64) legacytx.StdSignMsg {
	...
	stdFee := legacytx.NewStdFee(0, sdk.NewCoins(sdk.NewCoin(furytypes.FuryNativeToken, sdk.NewInt(fee))))
