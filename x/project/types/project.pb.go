...
// source: fury/project/v1/project.proto
...
type CreateAgentDoc struct {
	AgentDid github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=agent_did,json=agentDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"did" yaml:"did"`
...
func (m *CreateAgentDoc) GetAgentDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.AgentDid
	}
	return ""
...
type WithdrawFundsDoc struct {
	...
	RecipientDid github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=recipient_did,json=recipientDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"recipientDid" yaml:"recipientDid"`
...
func (m *WithdrawFundsDoc) GetRecipientDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
...
type ProjectDoc struct {
	...
	SenderDid  github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=sender_did,json=senderDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"senderDid" yaml:"senderDid"`
...
func (m *ProjectDoc) GetSenderDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *WithdrawalInfoDoc) GetRecipientDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.RecipientDid
	}
	return ""
...
type Claim struct {
	...
	ClaimerDid github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=claimer_did,json=claimerDid,proto3,casttype=github.com/furya-official/fury-blockchain/x/iid/types.DIDFragment" json:"claimer_did,omitempty" yaml:"claimer_did"`
...
func (m *Claim) GetClaimerDid() github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.ClaimerDid
	}
	return ""
...
func init() {
	proto.RegisterType((*UpdateProjectStatusDoc)(nil), "fury.project.v1.UpdateProjectStatusDoc")
	proto.RegisterType((*CreateAgentDoc)(nil), "fury.project.v1.CreateAgentDoc")
	proto.RegisterType((*UpdateAgentDoc)(nil), "fury.project.v1.UpdateAgentDoc")
	proto.RegisterType((*CreateClaimDoc)(nil), "fury.project.v1.CreateClaimDoc")
	proto.RegisterType((*CreateEvaluationDoc)(nil), "fury.project.v1.CreateEvaluationDoc")
	proto.RegisterType((*WithdrawFundsDoc)(nil), "fury.project.v1.WithdrawFundsDoc")
	proto.RegisterType((*ProjectDoc)(nil), "fury.project.v1.ProjectDoc")
	proto.RegisterType((*WithdrawalInfoDoc)(nil), "fury.project.v1.WithdrawalInfoDoc")
	proto.RegisterType((*Params)(nil), "fury.project.v1.Params")
	proto.RegisterType((*Claim)(nil), "fury.project.v1.Claim")
	proto.RegisterType((*GenesisAccountMap)(nil), "fury.project.v1.GenesisAccountMap")
	proto.RegisterMapType((map[string]string)(nil), "fury.project.v1.GenesisAccountMap.MapEntry")
	proto.RegisterType((*AccountMap)(nil), "fury.project.v1.AccountMap")
	proto.RegisterMapType((map[string]string)(nil), "fury.project.v1.AccountMap.MapEntry")
	proto.RegisterType((*WithdrawalInfoDocs)(nil), "fury.project.v1.WithdrawalInfoDocs")
	proto.RegisterType((*Claims)(nil), "fury.project.v1.Claims")
}

func init() { proto.RegisterFile("fury/project/v1/project.proto", fileDescriptor_1fcfbd691efecbfd) }
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FuryDid) > 0 {
		i -= len(m.FuryDid)
		copy(dAtA[i:], m.FuryDid)
		i = encodeVarintProject(dAtA, i, uint64(len(m.FuryDid)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CreateAgentDoc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AgentDid = github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FuryDid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FuryDid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *Claim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.ClaimerDid = github_com_furya_official_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Status", wireType)
