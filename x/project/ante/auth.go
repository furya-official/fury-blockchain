...
// func NewDefaultPubKeyGetter(keeper keeper.Keeper) furytypes.PubKeyGetter {
// 	return func(ctx sdk.Context, msg furytypes.FuryMsg) (pubKey cryptotypes.PubKey, err error) {
...
// func NewModulePubKeyGetter(keeper keeper.Keeper, didKeeper didkeeper.Keeper) furytypes.PubKeyGetter {
// 	return func(ctx sdk.Context, msg furytypes.FuryMsg) (pubKey cryptotypes.PubKey, err error) {
...
// 	pubKeyGetter furytypes.PubKeyGetter) sdk.AnteHandler {

// 	// Refer to inline documentation in app/app.go for introduction to why we
// 	// need a custom fury AnteHandler, and especially a custom AnteHandler for
// 	// project creation. Below, we will discuss the differences between the
// 	// custom fury AnteHandler and the project creation AnteHandler.
// 	//
...
// 	// (Note: default fury AnteHandler uses the Cosmos NewSetUpContextDecorator)
...
// 	// - Creates the signer's account (in the default fury AnteHandler, this is
...
// 	// 	//fury.NewSigGasConsumeDecorator(ak, sigGasConsumer, pubKeyGetter),
// 	// 	NewSigVerificationDecorator(ak, signModeHandler, pubKeyGetter),
// 	// 	furytypes.NewIncrementSequenceDecorator(ak, pubKeyGetter), // innermost AnteDecorator
// 	// )
// }
