...
import (
	...
	iidutil "github.com/furya-official/fury-blockchain/x/iid/util"
...
func pubKeyGetter(keeper projectkeeper.Keeper, iidKeeper iidkeeper.Keeper) libfury.PubKeyGetter {
	return func(ctx sdk.Context, msg libfury.FuryMsg, sigs []signing.SignatureV2) (pubKey cryptotypes.PubKey, err error) {
...
func (dfd DeductFeeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (newCtx sdk.Context, err error) {
	...
	expectedTotalFee := sdk.NewCoins(sdk.NewCoin(
		libfury.FuryNativeToken, sdk.NewInt(types.MsgCreateProjectTotalFee)))
	...
	transactionFee := sdk.NewCoins(sdk.NewCoin(
		libfury.FuryNativeToken, sdk.NewInt(types.MsgCreateProjectTransactionFee)))
