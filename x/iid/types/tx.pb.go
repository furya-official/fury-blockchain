...
func init() {
	...
	proto.RegisterType((*MsgUpdateIidMeta)(nil), "fury.iid.v1beta1.MsgUpdateIidMeta")
	...
	proto.RegisterType((*MsgUpdateIidMetaResponse)(nil), "fury.iid.v1beta1.MsgUpdateIidMetaResponse")
...
func (c *msgClient) UpdateMetaData(ctx context.Context, in *MsgUpdateIidMeta, opts ...grpc.CallOption) (*MsgUpdateIidMetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.iid.v1beta1.Msg/UpdateMetaData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateMetaData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.iid.v1beta1.Msg/UpdateMetaData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
