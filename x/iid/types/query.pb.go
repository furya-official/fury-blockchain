...
func init() {
	...
	proto.RegisterType((*QueryIidMetaDataRequest)(nil), "fury.iid.v1beta1.QueryIidMetaDataRequest")
	proto.RegisterType((*QueryIidMetaDataResponse)(nil), "fury.iid.v1beta1.QueryIidMetaDataResponse")
}
...
func (c *queryClient) MetaData(ctx context.Context, in *QueryIidMetaDataRequest, opts ...grpc.CallOption) (*QueryIidMetaDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.iid.v1beta1.Query/MetaData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_MetaData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.iid.v1beta1.Query/MetaData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
